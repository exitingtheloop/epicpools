...
export function FeatureSteps({
  ...
  imageHeight: _imageHeight = "h-[400px]",
}: FeatureStepsProps) {
  ...
  return (
    <div className={cn("p-8 md:p-12", className)}>
      <div className="max-w-7xl mx-auto w-full">
        <h2 className="section-title text-center tracking-[0.15em] mt-16 mb-20" style={{marginBottom:"50px"}}>
          {title}
        </h2>
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-10">
          ...
          <div
            className={cn(
              "order-1 md:order-2 relative h-[200px] md:h-[300px] lg:h-[400px] overflow-hidden lg"
            )}
          >
              ...
              {features.map(
                (feature, index) =>
                  index === currentFeature && (
                    <motion.div
                      key={index}
                      className="absolute inset-0 lg overflow-hidden"
